...
class FinanceDateRangeFilterWidget extends StatelessWidget {
  FinanceDateRangeFilterWidget({super.key});
  ...
  Future<void> _selectDateRange(BuildContext context) async {
    ...
    if (picked != null) {
      financialStore.setFilterAndFetch(picked);
    }
  }

  // Function to reset the filter
  void _resetFilter() {
    financialStore.setFilterAndFetch(null);
  }
  ...
  Widget build(BuildContext context) {
    return Observer(
      builder: (_) {
        final range = financialStore.currentFilterRange;
        return Column(
