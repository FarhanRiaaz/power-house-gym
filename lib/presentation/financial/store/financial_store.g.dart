...
mixin _$FinancialStore on _FinancialStore, Store {
  ...
  late final _$_filteredExpensesAtom = Atom(
    name: '_FinancialStore._filteredExpenses',
    context: context,
  );

  @override
  List<FinancialTransaction> get _filteredExpenses {
    _$_filteredExpensesAtom.reportRead();
    return super._filteredExpenses;
  }

  @override
  set _filteredExpenses(List<FinancialTransaction> value) {
    _$_filteredExpensesAtom.reportWrite(value, super._filteredExpenses, () {
      super._filteredExpenses = value;
    });
  }
